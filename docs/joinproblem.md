...
>[!warning]
>古语有云：“以人为镜，可以明得失。”五只猫有五只猫的规矩，对于违反规矩的人，当然是挂人一时爽，一直挂人一直爽。
...
服务器专用材质包可以从群文件目录`材质包（resourcePack）`里下载“五只猫材质包”，如下图所示。
...
FiveCats的游戏货币名字为 `西瓜籽` ，用于圈地、玩家之间交易，以及购买系统物品等。在正常情况下，**西瓜籽一般只能通过<font color=red>商品交易、红包/个人转账/赞助服务器/参与服务器活动</font>这几种方式获得**，。

本服目前的经济体系运作方式为**基于商品/劳动力的西瓜籽兑换**。玩家通过[系统商店](/systemshop)、[全球市场](/globalmarket)、[箱子商店](/quickshop)以及玩家间交♂易的方式，实现商品/劳动力与硬币的兑换流通。当然，偶尔也会有土豪向全服玩家发红包，但是要注意这并不是主流的获取硬币的方式。
...
+   MCMMO插件等一直提供<font color=red>即时反馈</font>的插件；
